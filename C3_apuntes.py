...
class Empleado:
    ...
    @classmethod # utilizar este método cuando hemos definido una propiedad en la clase
...
# Ejercicio clases: el nombre de la clase en mayusculas y cuando creamos un objeto en minusculas
...
print('Clase Electrodomestico (hija de Producto)')
...
# # MODULOS:
# Modulos propios: Existen diferentes formas de importar nuestros módulos.
# from mismodulos.matematicas import PI, sumar #importar funciones especificas
...
import mismodulos.matematicas as matematicas # importamos desde una carpeta que tenemos y le asignamos un alias
...
# El resto de la clase: realizada en Google Colab (mirar script C3_apuntes_GC)
